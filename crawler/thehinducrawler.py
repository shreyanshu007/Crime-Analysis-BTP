...
# News_site_toi("https://www.thehindu.com/", 10)
# theHinduNews("https://www.thehindu.com/news/cities/Delhi/man-held-for-killing-paramours-husband/article25721748.ece", 1)

if __name__ == '__main__':

    CITY_LIST = ['delhi', 'bangalore', 'mumbai', 'chennai', 'lucknow', 'chandigarh', 'hyderabad', 'kolkata', 'bengaluru']
    theHinduNews('https://www.thehindu.com/news/cities/bangalore/policeman-assaulted-while-rescuing-woman/article29326681.ece', 5, CITY_LIST)