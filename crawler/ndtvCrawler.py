...
def ndtvNews(url, depth, CITY_LIST):
                    ...
                    if link and link != URL:
                        ...
                        if 'http' not in link:
                            ...
                            if any(item in link for item in CITY_LIST):
                                ndtvNews(link, depth-1, CITY_LIST)

                        elif 'ndtv.com' in link:
                            # addition of all the urls present in this web page
                            if any(item in link for item in CITY_LIST):
                                ndtvNews(link, depth-1, CITY_LIST)
...
def NdtvTvNewsSiteCrawler(url, depth, CITY_LIST):
...
# News_site_toi("https://www.ndtv.com/topic/crime", 10)
# ndtvNews("https://www.ndtv.com/world-news/meghan-markles-father-asks-queen-elizabeth-to-get-his-daughter-back-in-touch-1963755?pfrom=home-topstories", 1)

if __name__ == '__main__':

    CITY_LIST = ['delhi', 'bangalore', 'mumbai', 'chennai', 'lucknow', 'chandigarh', 'hyderabad', 'kolkata']
    ndtvNews('https://www.ndtv.com/delhi-news/delhi-woman-killed-by-father-over-her-relationship-in-delhi-police-2098172', 5, CITY_LIST)
